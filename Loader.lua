...
if Loader.Screen.Enabled == false then
    ...
    local GameIds = {
        [3150475059] = "https://gist.githubusercontent.com/ByteDev0/0968bd469ef768dbfb68ab5462e8a096/raw/42865efe9a6fafe3b509016a3e9b0b63ecff6d69/FootballFusion2.lua",
